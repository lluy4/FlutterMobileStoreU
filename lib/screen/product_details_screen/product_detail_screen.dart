                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text(
                            product.offerPrice != null ? "${product.offerPrice?.toStringAsFixed(0)}đ" : "${product.price?.toStringAsFixed(0)}đ",
                          ...
                          const Spacer(),
                          Text(
                            product.quantity != 0 ? "Số lượng : ${product.quantity}" : "Không có sẵn",
                      ...
                      product.proVariantId!.isNotEmpty
                          ? Text(
                              ' ${product.proVariantTypeId?.type} sẵn có ',
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: product.quantity != 0
                              ...
                              : null,
                          child: const Text("Thêm vào giỏ hàng", style: TextStyle(color: Colors.white)),
                        ),
                      )
                    ],
                  ),
